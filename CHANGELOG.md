...
- **Sincronización WebAssembly & Erradicación de `function signature mismatch` ([`CMakeLists.txt`](file:///c:/Projects/DevilutionX/CMakeLists.txt), [`Source/engine/animationinfo.h`](file:///c:/Projects/DevilutionX/Source/engine/animationinfo.h), [`Packaging/emscripten/devilutionx.wasm`](file:///c:/Projects/DevilutionX/Packaging/emscripten/devilutionx.wasm), [`Packaging/emscripten/devilutionx.js`](file:///c:/Projects/DevilutionX/Packaging/emscripten/devilutionx.js))**:
  ...
  - Guarda defensiva en `AnimationInfo::currentSprite()` para acotar el índice de fotograma entre `0` y `numSprites() - 1`, previniendo lecturas fuera de rango (`memory access out of bounds`) cuando `ticksSinceSequenceStarted_` bajo-desborda (`-128`).
  - Sincronización del manifiesto de archivos en `devilutionx.js` con el tamaño canónico de `devilutionx.data` (6.165.185 bytes).
