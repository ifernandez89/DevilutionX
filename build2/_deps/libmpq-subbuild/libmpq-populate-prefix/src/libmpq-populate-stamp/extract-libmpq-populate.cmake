...
#
get_filename_component(filename "C:/Diablo/DevilutionX Repo/DevilutionX/build2/_deps/libmpq-subbuild/libmpq-populate-prefix/src/7c2924d4553513eba1a70bbdb558198dd8c2726a.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Diablo/DevilutionX Repo/DevilutionX/build2/_deps/libmpq-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libmpq-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libmpq-populate${i}")
