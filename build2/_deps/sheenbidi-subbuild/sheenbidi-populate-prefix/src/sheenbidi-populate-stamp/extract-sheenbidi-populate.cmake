...
#
get_filename_component(filename "C:/Diablo/DevilutionX Repo/DevilutionX/build2/_deps/sheenbidi-subbuild/sheenbidi-populate-prefix/src/v2.9.0.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/Diablo/DevilutionX Repo/DevilutionX/build2/_deps/sheenbidi-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-sheenbidi-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-sheenbidi-populate${i}")
