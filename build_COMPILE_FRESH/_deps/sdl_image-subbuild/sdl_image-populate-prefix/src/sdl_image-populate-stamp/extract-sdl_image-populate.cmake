...
#
get_filename_component(filename "C:/c - c++/DevilutionX/build_COMPILE_FRESH/_deps/sdl_image-subbuild/sdl_image-populate-prefix/src/release-2.0.5.tar.gz" ABSOLUTE)
get_filename_component(directory "C:/c - c++/DevilutionX/build_COMPILE_FRESH/_deps/sdl_image-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-sdl_image-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-sdl_image-populate${i}")
